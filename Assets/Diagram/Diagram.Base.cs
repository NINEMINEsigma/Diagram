...
#pragma warning restore IDE1006 // 命名样式
    ...
    namespace Timer
    {
        ...
        {
            public float time => UnityEngine.Time.time * SpeedMultiplier;

            public float deltaTime => UnityEngine.Time.deltaTime * SpeedMultiplier;
    ...
    public static class VectorExtension
    {
        ...
        public static Vector3 ToVector3(this Vector2 self, Vec22Vec3FillType type, float filled = 0)
        {
            return type switch
            {
                ...
                _ => throw new DiagramException("Unknown Axis"),
            };
        }
